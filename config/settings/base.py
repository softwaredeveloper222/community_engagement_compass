...
# knowledgeassistant/
APPS_DIR = BASE_DIR / "knowledgeassistant"
env = environ.Env()
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://postgres:softwaredeveloper@localhost:5432/knowledgeassistant_db",
    ),
}
...
ACCOUNT_FORMS = {"signup": "knowledgeassistant.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "knowledgeassistant.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "knowledgeassistant.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
